...
type Product struct {
	...
	Properties  []ProductPropertyValue `gorm:"foreignKey:ProductID;constraint:OnDelete:CASCADE;"`
	CreatedAt   time.Time
	UpdatedAt   time.Time
...
type ProductProperty struct {
	...
	Name      string
	Required  bool
	Values    []ProductPropertyValue `gorm:"foreignKey:PropertyCode;AssociationForeignKey:Code"`
	CreatedAt time.Time
	UpdatedAt time.Time
	DeletedAt gorm.DeletedAt `gorm:"index"`
}
